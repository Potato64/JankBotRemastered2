...
public class Constants
{
    ...
    public static final int CLIMB_LOWER_LIMIT = 0;
    public static final int CLIMB_UPPER_LIMIT = 2500;
    public static final int LIFT_LOWER_LIMIT = 2501;
    public static final int LIFT_UPPER_LIMIT = 5000;
